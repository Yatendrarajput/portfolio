...
import projectImage1 from "../assets/project1.jpg"; // Example project images
import projectImage2 from "../assets/project2.jpg"; // Example project images
    ...
    const projects = [
        {
            ...
            description:
                "This is a description of the project. It includes the purpose of the project, the technologies used, and what the project solves or achieves.",
            liveLink: "#",
            githubLink: "https://github.com/Yatendrarajput",
        },
        {
            image: projectImage2,
            title: "Project Title 2",
            description:
                "This project is focused on a different aspect of web development. The project includes features such as...",
            liveLink: "#",
            githubLink: "#",
        },
        {
